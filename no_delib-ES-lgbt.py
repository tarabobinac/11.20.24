...
def setup():
    os.environ['topic'] = 'los derechos LGBTQ'
    ...
    os.environ['intro_text'] = f"""¡Hablemos sobre {os.environ['topic']}! Primero, cuéntame algo que te confunda sobre {os.environ['topic']}."""
