...
def set_labels():
    ...
    os.environ['comment_outline'] = """
                    ...
                    **Você deve fornecer feedback (positivo, negativo ou neutro) para pelo menos duas respostas, selecionando pelo menos uma categoria e escrevendo um comentário para cada uma**, momento em que o botão **Enviar** será habilitado.
