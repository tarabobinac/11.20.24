...
def set_labels():
    ...
    os.environ['comment_outline'] = """
                ...
                **Debe proporcionar comentarios (positivos, negativos o neutrales) para al menos dos respuestas del chatbot, seleccionando al menos una categoría y escribiendo un comentario para cada una**. Luego de completar el mínimo de dos respuestas, el botón **Enviar** estará habilitado. 
