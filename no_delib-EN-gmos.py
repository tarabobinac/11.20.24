...
def setup():
    ...
    os.environ['intro_text'] = f"""Let’s talk about genetically modified organisms ({os.environ['topic']})! Start off by telling me something that puzzles you about {os.environ['topic']}."""

    os.environ['gen_max_tokens'] = '512'
    os.environ['gen_system_instruction'] = (f"""Engage in opinionated conversation on {os.environ['topic']}. You finish your response within {os.environ['gen_max_tokens']} tokens.
                                            Avoid asking \"yes\"/\"no\" questions.""")
    os.environ['shorter_system_instruction'] = (f"""Engage in opinionated conversation on {os.environ['topic']}.
                                            You provide shorter, more conversational responses. Avoid asking \"yes\"/\"no\" questions.""")
