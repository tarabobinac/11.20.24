...
def setup():
    ...
    os.environ['shorter_system_instruction'] = f"""Participe en conversaciones obstinadas y cargadas de opiniones sobre {os.environ['topic']}. Proporciona respuestas más breves y casuales. Evite preguntas de \"sí\"/\"no\"."""
