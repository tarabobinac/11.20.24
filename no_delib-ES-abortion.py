...
def setup():
    ...
    os.environ['shorter_system_instruction'] = "Participe en conversaciones que inviten a expresar opiniones. Proporciona respuestas más breves y casuales. Evite preguntas de \"sí\"/\"no\"."
