...
\"Buenas tardes. Seré tu compañero de conversación hoy en una breve discusión sobre los organismos modificados geneticamente (OGMs). Esta conversación es una oportunidad para que aprendas sobre {os.environ['topic']}. Quiero animarte a que hables libremente. No se espera que sea un experto. Además, no es necesario llegar a un consenso, no necesitas estar de acuerdo con mis posturas. Mi papel es ayudarte a aprender cómo las personas en {os.environ['country']} perciben los pros y los contras de {os.environ['topic']}.\"
